import { BetterAuthError, env, getEnvVar } from "./env-impl-BYU_0FTM.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/factory-DKOC6c1p.js
...
//#endregion
export { ATTR_CONTEXT, ATTR_HOOK_TYPE, ATTR_OPERATION_ID, __exportAll, __getBetterAuthGlobal, createAdapterFactory, createLogger, createRandomStringGenerator, generateId, getAsyncLocalStorage, getAuthTables, getBetterAuthVersion, getCurrentAdapter, import_src, initGetFieldName, initGetModelName, logger, queueAfterTransactionHook, runWithAdapter, runWithTransaction, safeJSONParse, shouldPublishLog, withSpan };
