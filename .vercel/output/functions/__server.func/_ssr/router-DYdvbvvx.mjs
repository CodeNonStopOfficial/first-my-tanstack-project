import { sql } from "./compiled-query-WAoO9V3N.mjs";
import { require_jsx_runtime } from "../_libs/@base-ui/react+[...].mjs";
import { APIError, APIError$1, BetterAuthError, BetterCallError, ENV, ValidationError, env, getBooleanEnvVar, getEnvVar, isDevelopment, isProduction, isTest, kAPIErrorHeaderSymbol } from "./env-impl-BYU_0FTM.mjs";
import { ATTR_CONTEXT, ATTR_HOOK_TYPE, ATTR_OPERATION_ID, __getBetterAuthGlobal, createAdapterFactory, createLogger, createRandomStringGenerator, generateId as generateId$2, getAsyncLocalStorage, getAuthTables, getBetterAuthVersion, getCurrentAdapter, import_src, initGetFieldName, initGetModelName, logger, queueAfterTransactionHook, runWithAdapter, runWithTransaction, safeJSONParse, shouldPublishLog, withSpan } from "./factory-DKOC6c1p.mjs";
import { createKyselyAdapter, getKyselyDatabaseType } from "./dist-5KV-bOtK.mjs";
import { betterFetch, createDefu, defu, getBaseURL, getHost, getOrigin, getProtocol, isDynamicBaseURLConfig, isRequestLike, normalizePathname, resolveBaseURL, wildcardMatch } from "./dist-8WoO05bK.mjs";
import { ZodObject, ZodOptional, _enum, any, array, boolean, boolean$1, email, ipv4, ipv6, looseObject, number, object, optional, record, string as string$1, string$1 as string } from "../_libs/zod.mjs";
...
import { CircleCheck, Info, LoaderCircle, OctagonX, TriangleAlert } from "../_libs/lucide-react.mjs";
import { ThemeProvider } from "./theme-provider-o93OQFIN.mjs";
import { z } from "../_libs/next-themes.mjs";
import { PrismaPgAdapterFactory } from "../_libs/@prisma/adapter-pg.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/router-DYdvbvvx.js
...
var styles_default = "/assets/styles-Di1uTrMG.css";
var Toaster$1 = ({ ...props }) => {
...
function RootDocument({ children }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("html", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("head", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HeadContent, {}) }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("body", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(ThemeProvider, { children: [children, /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toaster$1, {})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Scripts, {})] })]
	});
}
var $$splitComponentImporter$8 = () => import("./routes-CRcPIk2t.mjs");
var Route$9 = createFileRoute("/")({
	component: lazyRouteComponent($$splitComponentImporter$8, "component"),
	head: () => ({ meta: [{ title: "Learn TanStack Start | Build Full-Stack React Apps" }, {
		name: "description",
		content: "A hands-on tutorial teaching you how to build modern full-stack React applications with TanStack Start, Prisma, AI integration, and more."
	}] })
});
var $$splitComponentImporter$7 = () => import("./route-CAA3u1nn.mjs");
var Route$8 = createFileRoute("/_auth")({ component: lazyRouteComponent($$splitComponentImporter$7, "component") });
var $$splitComponentImporter$6 = () => import("./route-C0RMQsSG.mjs");
var Route$7 = createFileRoute("/dashboard")({ component: lazyRouteComponent($$splitComponentImporter$6, "component") });
var $$splitComponentImporter$5 = () => import("./dashboard-ASHPPaZH.mjs");
var Route$6 = createFileRoute("/dashboard/")({ component: lazyRouteComponent($$splitComponentImporter$5, "component") });
var $$splitComponentImporter$4 = () => import("./discover-CedizOMt.mjs");
var Route$5 = createFileRoute("/dashboard/discover")({ component: lazyRouteComponent($$splitComponentImporter$4, "component") });
var $$splitComponentImporter$3 = () => import("./import-DQ66C3PD.mjs");
var Route$4 = createFileRoute("/dashboard/import")({ component: lazyRouteComponent($$splitComponentImporter$3, "component") });
var $$splitComponentImporter$2 = () => import("./login-3eQ6FEB2.mjs");
var Route$3 = createFileRoute("/_auth/login/")({ component: lazyRouteComponent($$splitComponentImporter$2, "component") });
var $$splitComponentImporter$1 = () => import("./signup-TeKzzpQu.mjs");
var Route$2 = createFileRoute("/_auth/signup/")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
...
async function getBaseAdapter(options, handleDirectDatabase) {
	...
	if (!options.database) {
		...
		const { memoryAdapter } = await import("./dist-BIrxvUpw.mjs");
...
async function getAdapter(options) {
	return getBaseAdapter(options, async (opts) => {
		const { createKyselyAdapter } = await import("./kysely-adapter-e5IO0oJr.mjs");
		...
		const { kyselyAdapter } = await import("./kysely-adapter-e5IO0oJr.mjs");
...
var prisma = globalThis.__prisma || new PrismaClient({ adapter });
		...
		hooks: { after: [{
			...
			handler: createAuthMiddleware(async (ctx) => {
				...
				if (returned instanceof Headers) {
					...
					const { setCookie } = await import("./server-BXpJ_GcL.mjs").then((n) => n.server_exports);
...
var $$splitComponentImporter = () => import("./items-hmMtAwsX.mjs");
var Route = createFileRoute("/dashboard/items/")({ component: lazyRouteComponent($$splitComponentImporter, "component") });
var IndexRoute = Route$9.update({
	id: "/",
	path: "/",
	getParentRoute: () => Route$10
});
var AuthRouteRoute = Route$8.update({
	id: "/_auth",
	getParentRoute: () => Route$10
});
var DashboardRouteRoute = Route$7.update({
	id: "/dashboard",
	path: "/dashboard",
	getParentRoute: () => Route$10
});
...
var DashboardDiscoverRoute = Route$5.update({
	id: "/discover",
	path: "/discover",
	getParentRoute: () => DashboardRouteRoute
});
var DashboardImportRoute = Route$4.update({
	id: "/import",
	path: "/import",
	getParentRoute: () => DashboardRouteRoute
});
var AuthLoginIndexRoute = Route$3.update({
	id: "/login/",
	path: "/login/",
	getParentRoute: () => AuthRouteRoute
});
var AuthSignupIndexRoute = Route$2.update({
	id: "/signup/",
	path: "/signup/",
	getParentRoute: () => AuthRouteRoute
});
...
var DashboardItemsIndexRoute = Route.update({
	id: "/items/",
	path: "/items/",
	getParentRoute: () => DashboardRouteRoute
});
