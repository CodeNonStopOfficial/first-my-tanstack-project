...
import { getResponse, requestHandler } from "./server-BXpJ_GcL.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-gNDYTNRu.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DYdvbvvx.mjs"),
		import("./start-uAZ71WIG.mjs"),
